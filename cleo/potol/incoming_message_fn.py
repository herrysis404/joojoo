...
from cleo.hotol.download_aria_p_n import call_apropriate_function, call_apropriate_function_g, aria_start
from cleo.hotol.download_from_link import request_download
from cleo.hotol.display_progress import progress_for_pyrogram
from cleo.hotol.youtube_dl_extractor import extract_youtube_dl_formats
from cleo.hotol.admin_check import AdminCheck
from cleo.hotol.ytplaylist import yt_playlist_downg
from cleo.hotol.cloneHelper import CloneHelper
...
async def incoming_message_f(client, message):
   ...
   # credit = await message.reply_text(f"🧲 Leeching for you <a href='tg://user?id={g_id}'>🤕</a>", parse_mode="html")
    i_m_sefg = await message.reply_text("Processing <a href='tg://user?id={g_id}'>🤕</a>", quote=True)
    is_zip = False
    is_unzip = False
    is_unrar = False
    is_untar = False
