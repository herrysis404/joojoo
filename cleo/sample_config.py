...
class Config(object):
    ...
    FREE_USER_MAX_FILE_SIZE = 1099511627776
    ...
    #
    ARIA_TWO_STARTED_PORT = int(os.environ.get("ARIA_TWO_STARTED_PORT", 26819))
    EDIT_SLEEP_TIME_OUT = int(os.environ.get("EDIT_SLEEP_TIME_OUT", 8))
