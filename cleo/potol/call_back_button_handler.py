...
from cleo.hotol.download_aria_p_n import aria_start
from cleo.hotol.youtube_dl_button import youtube_dl_call_back
from cleo.potol.status_message_fn import cancel_message_f
from cleo import (
    MAX_MESSAGE_LENGTH,
    AUTH_CHANNEL
)
    ...
    if "|" in cb_data:
        ...
        if cb_data.startswith("cancel"):
            ...
            if update.from_user.id in AUTH_CHANNEL:
                ...
                await update.message.edit_text("You are not admin and do not allowed to do that 🤭")
